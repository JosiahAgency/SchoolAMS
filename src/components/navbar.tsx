    ...
    <div className='flex justify-between items-center p-4'>
      ...
      <div className="flex items-center gap-6 justify-end w-full">
        ...
        <div className="bg-white rounded-full w-7 h-7 flex justify-center items-center cursor-pointer">
          ...
          <div className="absolute mb-7 ml-7  w-5 h-5 flex items-center justify-center bg-purple-600 text-white rounded-full text-xs">1</div>
        </div>
        <div className="flex flex-col">
          <span className='text-xs leading-3 font-medium'>George Josiah</span>
